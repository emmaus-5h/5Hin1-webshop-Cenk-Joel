...
insert into products  (name, description, code, price, minuten, rating_id, tickets_id, airline_id)  values ('Rabat', 'Rabat is een stad met een zeer rijke en eeuwenoude geschiedenis. De bevolking daar is vredelievend en heeft het moderne leven met de traditionele waarden en normen geïntegreerd.', '693155505-7', 13.5, 80, 1, 2, 1);
